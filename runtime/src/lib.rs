...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("Pixel-parachain"),
    impl_name: create_runtime_str!("Pixel-parachain"),
    authoring_version: 1,
    spec_version: 1,
    impl_version: 0,
...
pub struct PixelGasWeightMapping;
impl pallet_evm::GasWeightMapping for PixelGasWeightMapping {
...
impl pallet_evm::Config for Runtime {
    ...
    type GasWeightMapping = PixelGasWeightMapping;
